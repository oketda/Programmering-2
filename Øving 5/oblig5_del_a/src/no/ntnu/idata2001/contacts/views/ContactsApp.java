...
public class ContactsApp extends Application {
  ...
  private AdressBookDBHandler addressBookDBHandler;
  private AddressBook addressBook;

  // The JavaFX ObservableListWrapper used to connect to the underlying AddressBook
  ...
  public void init() throws Exception {
    ...
    this.addressBookDBHandler = new AdressBookDBHandler();
  ...
  private ObservableList<ContactDetails> getAddressBookListWrapper() {
    ...
    addressBookListWrapper
      = FXCollections.observableArrayList(addressBookDBHandler.getAllContacts());
  ...
  private MenuBar createMenus() {
    ...
    exportToCsv.setOnAction(event -> mainController.exportToCsv(addressBookDBHandler));
