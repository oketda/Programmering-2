...
class TestBonusMember{
    public static void main(String[] args) throws Exception {
        ...
        Personals herman = new Personals("Herman", "Aagaard", "herman.aagaard@gmail.com", "herman");
        ...
        //b1.addBonusMember(100, ole, LocalDate.of(2006, 2, 15), 0);
        ...
        MemberArchive ma = new MemberArchive(100, ole, LocalDate.of(2006, 2, 15), 0);
        GoldMember g1 = new GoldMember(160, herman, LocalDate.of(2010, 4, 20), 45000);

        System.out.println("Find points");
        System.out.println(ma.findPoints(100, "ole"));
        ma.registerPoints(100, 1000);
        ma.registerPoints(160, 1000);
        System.out.println("Test for registerPoints for basic member:");
        System.out.println(ma.findPoints(100, "ole"));
        System.out.println("Test for registerPoints for gold member:");
        System.out.println(ma.findPoints(160, "herman"));

        System.out.println("Test for newMember()");
        System.out.println(ma.newMember("Nordmann", "Ola", "ola.nordmann@mail.com", "ola", LocalDate.of(2019, 2, 21)));
        System.out.println("Test if checkMembers() works for silver upgrade");
        ma.checkMembers();
        System.out.println(ma.checkMembersTestSilver(100));
        ma.registerPoints(100, 40000);
        ma.checkMembers();
        System.out.println("Test if checkMembers() works for gold upgrade");
        System.out.println(ma.checkMembersTestGold(100));
        System.out.println("Test if checkMembers() removes from previous bracket when upgraded (return false = works)");
        System.out.println(ma.checkMembersTestSilver(100));
        System.out.println();
        System.out.println("Test for getClass()");
        System.out.println(ma.checkMembersTest(100));
    }
}